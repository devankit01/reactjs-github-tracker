          ...
          <div className="user__info">
            ...
            <div className="user__bio">
              ...
              <div className="user__extra">
                ...
                <p><i class="far fa-building"></i>&nbsp;Coding Addict</p>
                <p><i class="fas fa-map-marker-alt"></i>&nbsp;Lucknow, India</p>
                <p><i class="fas fa-paperclip"></i>&nbsp;www.medev.in</p>
              </div>
          ...
          <div className="user__repos">
            ...
            <div className="repos">
              <p>
                ...
                Laborum, est! Incidunt similique culpa unde, excepturi quas
                aliquid! Dolore corporis repellendus eveniet voluptatem fugiat
                perspiciatis dignissimos ullam earum labore, dolorem recusandae!
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Laborum, est! Incidunt similique culpa unde, excepturi quas
                aliquid! Dolore corporis repellendus eveniet voluptatem fugiat
                perspiciatis dignissimos ullam earum labore, dolorem recusandae!
